...
updateConfig(path.join(__dirname, '../..', 'okta-hosted-login', '/dist/okta-aspnet-mvc-example/Web.config'));
updateConfig(path.join(__dirname, '../..', 'self-hosted-login', '/dist/okta-aspnet-mvc-example/Web.config'));
